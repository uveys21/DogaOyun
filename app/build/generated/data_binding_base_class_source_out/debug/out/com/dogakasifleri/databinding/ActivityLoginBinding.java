...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvRegisterPrompt;

  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull TextView btnRegister, @NonNull TextInputEditText etPassword,
      @NonNull TextInputEditText etUsername, @NonNull ImageView ivLoginLogo,
      ...
      @NonNull TextView tvRegisterPrompt) {
    ...
    this.tvRegisterPrompt = tvRegisterPrompt;
  }
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvRegisterPrompt;
      TextView tvRegisterPrompt = ViewBindings.findChildViewById(rootView, id);
      if (tvRegisterPrompt == null) {
        break missingId;
      }

      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnRegister,
          etPassword, etUsername, ivLoginLogo, tilPassword, tilUsername, tvForgotPassword,
          tvLoginTitle, tvRegisterPrompt);
    }
